...
export class SessionService {
  ...
  constructor (private http: HttpClient , private loginService : LoginService) { 
   ...
   setSessions () {
    ...
    return new Promise( ( resolve , reject ) => {
      ...
      this.http.post<any>( Constants.BASE_URL + 'sessions' , requestJson )
        .subscribe((data) => {
   ...
   createSession(newSession) { 
     return new Promise((resolve, reject) => {
       this.http.post(Constants.BASE_URL + 'session', newSession)
       .subscribe((data) => {
          this.setSessions();
          console.log(data);
          resolve();
  ...
  updateSession( updatedSession ) {
    return new Promise( (resolve,reject) => {
      this.http.put(Constants.BASE_URL + 'session/' + updatedSession.id , updatedSession)
       .subscribe((data) => {
          this.setSessions();
          console.log(data);
          resolve();
